...
const STATUS_STYLES: Record<string, { bg: string; color: string }> = {
  ...
  ARQUIVADO: { bg: "oklch(0.94 0.01 250)", color: "oklch(0.45 0.02 250)" },
  PROPRIO: { bg: "oklch(0.94 0.05 150)", color: "oklch(0.4 0.12 150)" },
  LOCADO: { bg: "oklch(0.93 0.04 250)", color: "oklch(0.4 0.14 255)" },
  COMODATO: { bg: "oklch(0.95 0.05 85)", color: "oklch(0.45 0.12 75)" },
